	...
	<div class="container mt-64 mb-64 mt-32-mobile mb-32-mobile">
		<div class="row justify-content-center">
			<div class="col-lg-6 order-lg-2 col-md-6 order-md-2 col-sm-12 order-sm-1 col-12 order-1 mb-32-mobile">
				<h3>Connect</h3>
				<hr />
				<a href="https://www.twitter.com/TheBillionDrive"><p><span class="icon-twitter-square" style="top: 2px; position: relative;"></span> Twitter</p></a>
				<a href="https://www.instagram.com/billionairesdrive"><p><span class="icon-instagram" style="top: 2px; position: relative;"></span> Instagram</p></a>
				{{-- <hr />
