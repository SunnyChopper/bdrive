		...
		<div class="row">
			<div class="col-lg-10 offset-lg-1 col-md-10 offset-md-1 col-sm-12 col-xs-12">
				<div class="gray-box">
					...
					<hr />
					<form action="/admin/courses/update" method="post" id="update_course_form">
						...
						<div class="form-group mb-64">
							...
							<textarea name="description" class="form-control" rows="15" form="update_course_form">{{ $course->description }}</textarea>
						</div>

						<div class="form-group mb-64">
							<h5>YouTube Video ID:</h5>
							<input type="text" name="preview_video" value="{{ $course->preview_video }}" class="form-control">
						</div>

						<div class="form-group mb-64">
							<h5>Amount<span class="red">*</span>:</h5>
							<input type="number" name="amount" step="0.01" min="0.00" class="form-control" value="{{ $course->amount }}" required>
						</div>
